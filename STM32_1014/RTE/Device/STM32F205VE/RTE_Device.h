...
// <h> USART Buffer Size
//   <o> USART1 TxBuffer (Buffer size must be 2^n)
#define __UART1_TX_BUFFER_SIZE							512
//   <o> USART1 RxBuffer (Buffer size must be 2^n)
#define __UART1_RX_BUFFER_SIZE							512
//   <o> USART2 TxBuffer (Buffer size must be 2^n)
#define __UART2_TX_BUFFER_SIZE							512
//   <o> USART2 RxBuffer (Buffer size must be 2^n)
#define __UART2_RX_BUFFER_SIZE							512
//   <o> USART3 TxBuffer (Buffer size must be 2^n)
#define __UART3_TX_BUFFER_SIZE							512
//   <o> USART3 RxBuffer (Buffer size must be 2^n)
#define __UART3_RX_BUFFER_SIZE							512
//   <o> USART4 TxBuffer (Buffer size must be 2^n)
#define __UART4_TX_BUFFER_SIZE							512
//   <o> USART4 RxBuffer (Buffer size must be 2^n)
#define __UART4_RX_BUFFER_SIZE							512
//   <o> USART6 TxBuffer (Buffer size must be 2^n)
#define __UART6_TX_BUFFER_SIZE							512
//   <o> USART6 RxBuffer (Buffer size must be 2^n)
#define __UART6_RX_BUFFER_SIZE							512
// </h>
